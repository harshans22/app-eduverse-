                  ...
                  children: [
                    Stack(
                      children: [
                       ...
                       controller.value.isPlaying?Container(): Container(
                       ...
                       controller.value.isPlaying?Container(): Positioned(bottom:0,
                       right:0,
                       left:0,
                        child: VideoProgressIndicator(padding:EdgeInsets.only(bottom: 10),
                       ...
                       right:0,
                       left:0,
                          child: controller.value.isPlaying?Container():Container(alignment: Alignment.center,
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(view[0].comments[0].message,style: TextStyle(color: Colors.grey),),
                                        Row(
                                          mainAxisAlignment:
